...
template <typename Dtype>
void BiConvolution3DLayer<Dtype>::binarizeGPUTo(const shared_ptr<Blob<Dtype> > weights, const shared_ptr<Blob<Dtype> > wb) {
...
template <typename Dtype>
Dtype BiConvolution3DLayer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void BiConvolution3DLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
