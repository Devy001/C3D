...
#ifndef BICONVOLUTION3D_LAYER_HPP_
#define BICONVOLUTION3D_LAYER_HPP_
...
class BiConvolution3DLayer : public Layer<Dtype> {
 public:
  explicit BiConvolution3DLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
